import { AudioRecorderError, AudioRecorderState, CopilotChatAudioRecorder } from "./components/chat/CopilotChatAudioRecorder.cjs";
import { CopilotChatConfigurationProvider, CopilotChatConfigurationProviderProps, CopilotChatConfigurationValue, CopilotChatLabels, useCopilotChatConfiguration } from "./providers/CopilotChatConfigurationProvider.cjs";
import { CopilotChatInput, CopilotChatInputProps, ToolsMenuItem } from "./components/chat/CopilotChatInput.cjs";
import { CopilotChatToolCallsView, CopilotChatToolCallsViewProps } from "./components/chat/CopilotChatToolCallsView.cjs";
import { CopilotChatAssistantMessage, CopilotChatAssistantMessageProps } from "./components/chat/CopilotChatAssistantMessage.cjs";
import { CopilotChatUserMessage, CopilotChatUserMessageProps } from "./components/chat/CopilotChatUserMessage.cjs";
import { CopilotChatReasoningMessage, CopilotChatReasoningMessageProps } from "./components/chat/CopilotChatReasoningMessage.cjs";
import { CopilotChatSuggestionPill, CopilotChatSuggestionPillProps } from "./components/chat/CopilotChatSuggestionPill.cjs";
import { CopilotChatSuggestionView, CopilotChatSuggestionViewProps } from "./components/chat/CopilotChatSuggestionView.cjs";
import { CopilotChatMessageView, CopilotChatMessageViewProps } from "./components/chat/CopilotChatMessageView.cjs";
import { CopilotChatView, CopilotChatViewProps } from "./components/chat/CopilotChatView.cjs";
import { CopilotChat, CopilotChatProps } from "./components/chat/CopilotChat.cjs";
import { CopilotChatToggleButton, CopilotChatToggleButtonProps, DefaultCloseIcon, DefaultOpenIcon } from "./components/chat/CopilotChatToggleButton.cjs";
import { CopilotModalHeader, CopilotModalHeaderProps } from "./components/chat/CopilotModalHeader.cjs";
import { CopilotSidebarView, CopilotSidebarViewProps } from "./components/chat/CopilotSidebarView.cjs";
import { CopilotPopupView, CopilotPopupViewProps } from "./components/chat/CopilotPopupView.cjs";
import { CopilotSidebar, CopilotSidebarProps } from "./components/chat/CopilotSidebar.cjs";
import { CopilotPopup, CopilotPopupProps } from "./components/chat/CopilotPopup.cjs";
import { WildcardToolCallRender } from "./components/WildcardToolCallRender.cjs";
import { CopilotKitInspector, CopilotKitInspectorProps } from "./components/CopilotKitInspector.cjs";
import { MCPAppsActivityContent, MCPAppsActivityContentSchema, MCPAppsActivityRenderer, MCPAppsActivityType } from "./components/MCPAppsActivityRenderer.cjs";
import "./components/index.cjs";
import { useRenderToolCall } from "./hooks/use-render-tool-call.cjs";
import { ReactCustomMessageRenderer, ReactCustomMessageRendererPosition } from "./types/react-custom-message-renderer.cjs";
import { useRenderCustomMessages } from "./hooks/use-render-custom-messages.cjs";
...
import { UseAgentUpdate, useAgent } from "./hooks/use-agent.cjs";
