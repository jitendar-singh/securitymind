import { t as isEmpty } from "./isEmpty-Bh5VUBhm.js";
import { B as select_default, H as __name, U as log, W as setLogLevel } from "./src-CR84UVIW.js";
import { F as reset, G as setSiteConfig, H as setConfig, J as styles_default, M as registerDiagram, N as registerLazyLoadedDiagrams, S as getDiagramLoader, T as getSiteConfig, X as updateSiteConfig, Y as themes_default, Z as purify, c as configureSvgSize, f as detectType, g as frontMatterRegex, h as evaluate, l as defaultConfig, n as addDirective, p as detectors, r as assignWithDepth_default, t as UnknownDiagramError, w as getEffectiveHtmlLabels, x as getDiagram, y as getConfig, z as saveConfigFromInitialize } from "./chunk-7R4GIKGN-BypTF7eD.js";
import { a as encodeEntities, d as isDetailedError, h as utils_default, i as decodeEntities, m as removeDirectives, r as cleanAndMerge } from "./chunk-GEFDOKGD-D8vg7tRC.js";
import { t as selectSvgElement } from "./chunk-HHEYEP7N-BsBuil8m.js";
import { i as registerIconPacks, o as dedent } from "./chunk-PU5JKC2W-D5Xq_rqa.js";
import "./chunk-MX3YWQON-B65D63Nt.js";
import "./chunk-YBOYWFTD-CyKpDI6n.js";
import "./chunk-PQ6SQG4A-CvfdZea1.js";
import "./chunk-KYZI473N-BiAebrVU.js";
import "./chunk-O4XLMI2P-Dg_2lrb9.js";
import { n as registerLayoutLoaders } from "./chunk-GLR3WWYH-DSdUwHD2.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-XPW4576I-dPAKaS4M.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-IC4MRINW-BEssKchW.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-PKNHOUZH-Cd-idk2p.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-INFDFZHY-DI8MYjEB.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-K3NZZRJ6-CQHPAwOV.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-A5KZAMGK-BBNy6WCi.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-LFFYTUFH-Dy_jfd6x.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-SKSYHLDU-B_FMInX_.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-337W2JSQ-CR5ztP6p.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-JWTSCODW-C0izalwj.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-Z7DCOOCP-cyRmb57M.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-2WXFIKYE-DMPc7INn.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-VBA2DB6C-wmCCinrJ.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-RAHNMMFH-KQrZr8mk.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-RAJIS63D-DjDNxmcC.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-FVOUBMTO-s52VewfI.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-4ABVD52K-B1Fo4aI0.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var detector_default2 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-YZTLITO2-D_8EWBH_.js");
		return {
			id: id19,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-YRQLILUH-Cz63fSuf.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-K7BYSVSG-CAlzQTey.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-WA2Y5GQK-B95rpkKg.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-P4PSJMXO-uwTHPI7Z.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-IFDJBPK2-ohqNwyqI.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-WCTKOSBZ-BkGtCfL0.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-2XIMDMQ5-CMsNQYjR.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-PHBUUO56-jrJ_qWv_.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-LZ73GAT5-CdSUDAnE.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-E7M64L7V-iew3aXWq.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
//# sourceMappingURL=mermaid.core-CbW6LSSJ.js.map