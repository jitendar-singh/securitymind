import React$1, { TextareaHTMLAttributes } from "react";
import { DocumentPointer } from "@copilotkit/react-core";
import { Message } from "@copilotkit/runtime-client-gql";

//#region src/types/base/autosuggestions-bare-function.d.ts
...
//#endregion
//#region src/types/base/base-autosuggestions-config.d.ts
/**
...
//#endregion
//#region src/types/base/base-copilot-textarea-props.d.ts
/**
...
//#endregion
//#region src/components/base-copilot-textarea/base-copilot-textarea.d.ts
/**
 ...
 */
interface HTMLCopilotTextAreaElement$1 extends HTMLElement {
  /**
 ...
 */
declare const BaseCopilotTextarea: React$1.ForwardRefExoticComponent<BaseCopilotTextareaProps & React$1.RefAttributes<HTMLCopilotTextAreaElement$1>>;
//#endregion
//#region src/types/html-copilot-textarea-element.d.ts
...
//#endregion
//#region src/types/autosuggestions-config/subtypes/make-system-prompt.d.ts
type MakeSystemPrompt = (textareaPurpose: string, contextString: string) => string;
//#endregion
//#region src/types/autosuggestions-config/suggestions-api-config.d.ts
...
//#endregion
//#region src/types/autosuggestions-config/insertions-api-config.d.ts
...
//#endregion
//#region src/types/autosuggestions-config/editing-api-config.d.ts
...
//#endregion
//#region src/types/autosuggestions-config/autosuggestions-config.d.ts
...
//#endregion
//#region src/types/autosuggestions-config/autosuggestions-config-user-specified.d.ts
...
//#endregion
//#region src/components/copilot-textarea/copilot-textarea.d.ts
 ...
 */
declare const CopilotTextarea: React$1.ForwardRefExoticComponent<CopilotTextareaProps & React$1.RefAttributes<HTMLCopilotTextAreaElement>>;
//#endregion
export { type AutosuggestionsBareFunction, type AutosuggestionsConfig, type AutosuggestionsConfigUserSpecified, type BaseAutosuggestionsConfig, BaseCopilotTextarea, type BaseCopilotTextareaProps, CopilotTextarea, type CopilotTextareaProps, HTMLCopilotTextAreaElement, type InsertionsApiConfigUserSpecified, type MakeSystemPrompt, type SuggestionsApiConfigUserSpecified, defaultAutosuggestionsConfig, defaultBaseAutosuggestionsConfig };
